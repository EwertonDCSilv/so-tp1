...
Ewerton Silva Santos <ewerton_dc@hotmail.com>. 
Realizou a tarefa de buscar pelas referencias no livros, estudando o funcionamento de cada uma das system calls e funções utilizadas(execvp, dup, fork, open, close, pipe) , revisando também o material da disciplina relacionados a pipe lines. Implementou o case de redirecionamento, a função copyClose para auxiliar na manipulação de descritor de arquivos e metade do case de pipe.

Rafael Oliveira Prado Nascimento <rafaelnascimento@dcc.ufmg.br>.
Realizou a tarefa de buscar pelas referencias no livros, estudando o funcionamento de cada uma das system calls e funções utilizadas(execvp, dup, fork, open, close, pipe) , revisando também o material da disciplina relacionados a pipe lines. Implementou o case de redirecionamento, o case para comandos simples e metade do case de pipe.
